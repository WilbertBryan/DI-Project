...
<body>
    ...
    <section class="header-section">
        <div class="container">
            ...
            <a class="btnDaftar" href="{{ $info->register }}">Daftar</a>
            @endif
        </div>
    </section>
    ...
    <section class="content-section container">
        <div class="content col-md-8">
            {!! nl2br(e($info->long_description)) !!}
        </div>

        <div class="download-section">
            <div class="card" style="width: 18rem;">
                <img src="{{ asset($info->image_path) }}" class="card-img-top" alt="{{ $info->title }}"
            ...
            <div class="contact-section mt-4">
                @if (!empty($info->website) && !empty($info->instagram) && !empty($info->whatsapp))
                    <p>Info lebih lanjut:</p>
                    @if (!empty($info->website))
                        <a href="{{ $info->website }}">
                            <img src="https://img.icons8.com/color/48/000000/google-logo.png" class="contact-icon"
                                width="20" height="20" /> {{ $info->title }}.com
                        </a>
                    @endif
                    @if (!empty($info->instagram))
                        <a href="{{ $info->instagram }}">
                            <img src="https://img.icons8.com/fluent/48/000000/instagram-new.png" class="contact-icon"
                                width="20" height="20" /> {{ $info->title }}.id
                        </a>
                    @endif
