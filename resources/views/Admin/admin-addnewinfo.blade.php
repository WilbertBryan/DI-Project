    ...
    <div class="d-flex">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-4">
            <div class="container mt-4">
                @include('alert')
                <h2>Add New Info</h2>
                <form method="post" action="{{route('PostAddInfo')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="download" class="form-label">Download Guide Link</label>
                        <input type="text" class="form-control" id="download" name="download" placeholder="Enter download link">
                    </div>
                    <div class="mb-3">
                        <label for="website" class="form-label">Website Link</label>
                        <input type="text" class="form-control" id="website" name="website" placeholder="Enter website link">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="whatsapp" name="whatsapp" placeholder="Enter WhatsApp link">
                    </div>
